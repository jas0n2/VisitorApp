   ...
   public static ArrayList<Visitors> visitorsArrayList;
    ...
    public void allVisitors(){
        ...
        while (cursor.moveToNext()){
            Visitors visitors = new Visitors(cursor.getString(1),cursor.getString(6),cursor.getString(5),cursor.getString(7),cursor.getString(8),cursor.getString(11),cursor.getString(13),cursor.getString(4),cursor.getString(13),cursor.getInt(0));
